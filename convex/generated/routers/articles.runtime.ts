...
const procedureRegistry = {
  "extract": ["action", typedProcedureResolver(createGeneratedFunctionReference<"action", "public", typeof import("../../routers/articles").extract>("routers/articles:extract"), () => (require("../../routers/articles") as Record<string, unknown>)["extract"])],
} as const;
...
export function createRoutersArticlesCaller<TCtx extends ProcedureCallerContext>(
  ctx: TCtx
...
export function createRoutersArticlesHandler<TCtx extends ProcedureHandlerContext>(
  ctx: TCtx
